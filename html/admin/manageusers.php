...
<nav id="login">
	<ul>
		<li><a href="aborrow.php">Borrow</a></li>
		<li><a href="areturn.php">Return</a></li>
		<li><a href="apayfees.php">Pay Fees</a></li>
		<li><a href="acreateaccount.php">Create an Account</a></li>
                <li><a href="aupdateaccount.php">Update an Account</a></li>
	</ul>
</nav>
